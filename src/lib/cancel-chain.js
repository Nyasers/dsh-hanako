...
//
// src/lib/cancel-chain.js — dsh_session cancel / 执行超时取消编排（App 主进程侧，步骤 4a）
//
// 职责（迁移指南 §9 取消链 4 步在 v2 的落点，决策 E 见 DESIGN「步骤 4a 架构决策」）：
//   ① 触发：dsh_session(action=cancel)（本模块 cancelDshTask）或执行超时看门狗
