...
//
// src/lib/controller.js — DSH 控制面客户端（App 侧；对齐官方样例 hana-dsh 的 controller.invoke）
//
// 落点：App 工具（dsh_session）**不直接访问 DSH HTTP**，而是经宿主 `ctx.runtime.fetch(runtimeId,
// "/_control")` 打到 runtime 内中继的控制面（src/runtime/bridge.js 的 /_control，controlKey 鉴权），
...
import { buildClientRequest, parseServerResponse } from "./rpc-envelope.js";
