...
// dsh_session 派发任务后只能等完成或超时，本工具提供主动取消：经总线 rpc.request 调 dsh web host
...
// → throw DSH_ABORTED → promise.catch 以 aborted 终态收尾（deferred fail 带「dsh_session 已取消」唤醒 Agent）。
