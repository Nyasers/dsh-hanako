...
// 与 dsh-run.js 同一纪律：本工具不静态 import dsh-run.js（Hana 以 ?t= 时间戳加载
// tools，静态 import 会命中 Node ESM 固定 URL 缓存读到旧模块，见 dsh-run.js 头部
// 注释），经 globalThis 单例（g.checkDshUpdate / g.updateDsh / g.bus）调用；
